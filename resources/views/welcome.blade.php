    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium">PHP Elastic Client</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Laravel & Elasticsearch PHP client for search</p>
                <ul class="flex flex-col mb-4 lg:mb-6">
                    <li
                        ...
                        <span>
                            Read the
                            <a href="https://www.elastic.co/docs/reference/elasticsearch/clients/php" target="_blank"
                ...
                <ul class="flex gap-3 text-sm leading-normal">
                    <li>
                        <a href="{{ route('news-articles.search') }}" target="_blank"
            ...
            <div
                ...
                <img src="{{ asset('asset/img/Elastic-Prime.jpg') }}" alt="">
